...
public class atividadeE5 {
    public static void main(String[] args) {
        ...
        System.out.println("O nível de estoque atual (" + estoque + ") está abaixo do mínimo (" + estoqueMinimo + ")? " + abaixoMinimo);

        int foraCaixas = estoque % tamanhoLote;
        boolean fracionadoCompleto = (foraCaixas == 0);

        System.out.println("Unidades fora de caixas fechadas de " + tamanhoLote + ": " + foraCaixas);
        System.out.println("O estoque está perfeitamente fracionado em caixas completas? " + fracionadoCompleto);
